      ...
      <div className="container" >
        <div className="row justify-content-center">
          <div className="col-lg-8 cl-md-10">
            ...
            <li>Mr. <span style={{fontWeight: "bold" }}>Seyed Iman Mirzadeh</span>, Ph.D. student, Washington State University, USA</li>
            <li>Dr. <span style={{fontWeight: "bold" }}>Mehrdad Farajtabar</span>, Research Scientist, DeepMind, USA</li>
            <li>Dr. <span style={{fontWeight: "bold" }}>Jialong Wu</span>, Assistant Professor, Shandong University, China</li>
            <li>Dr. <span style={{fontWeight: "bold" }}>Yunhe Wang</span>, Principal Researcher, Noah's Ark Lab, China</li>
            <li>Dr. <span style={{fontWeight: "bold" }}>Xiangyu Zhang</span>, Research Leader, MEGVII Technology, China</li>
            <li>Dr. <span style={{fontWeight: "bold" }}>Hongyang Zhang</span>, Postdoc Fellow, TTIC, USA</li>
            <li>Dr. <span style={{fontWeight: "bold" }}>Jianping Shi</span>, Executive Research Director, SenseTime, China</li>
            <li>Dr. <span style={{fontWeight: "bold" }}>Chen Qian</span>, Executive Research Director, SenseTime, China</li>
